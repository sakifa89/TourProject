...
<button class="button button2"><a href="">Police station</a>
</button>
<button class="button button3"><a href="">Fire-service</a></button>
</center><br>
<center><h3>Select Your nearest hospital</h3></center>
<div class="fix Search">
			    
				<center>
		   <h2>Enter district name here.....</h2>
		   <form action='http://localhost/search1.php' method='get'>
