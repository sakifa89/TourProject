...
<html>
<head>
<title>Police station name search</title>
...
<button class="button button3"><a href="fire.php">Fire-service</a></button>
</center><br>
<center><h3>Select Your nearest Police Station...</h3></center>
<div class="fix Search">
			    
				<center>
				<br>
		   <h2>Enter district name here.....</h2>
		   <form action='http://localhost/search2.php' method='get'>
		...
		<center>
		<p><b>&copy; SAKIFA AKTAR,All Rights Reserved</b></p>
		</center>
		</div>
		</div>
