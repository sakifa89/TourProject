...
<body>
  ...
  <li><a href="flipgalary.html">Transportation</a></li>
		...
		<center><h2><b>Plane Schedule</b></h2></center>
		   
		
		   <div class="fix content"> 
		   
		   <h2>Plane schedule .....</h2>
		   ...
		   <form action="" method="get">
            Leaving From:
                <select name="search_leavingform" id="search_leavingform" class="select">
					...
					<option value="Cox's Bazer" label="Cox's Bazer">Cox's Bazer</option>
                    ...
                    <option value="Saidpur" label="Saidpur">Saidpur</option>
            ...
            <br> <br>                                                                                                        
            <button type="button" id='search_submit' name='search_submit' onclick = "return showTablePlane()" >Search</button>
...
<hr/>
		   ...
		   <div class="fix pic">
		<img src="images/plane1.jpg" style:"width:500px;height:460px;">
